...
# ── Default editable public contacts ────────────────────────────────────────
DEFAULT_CONTACTS: Dict[str, Any] = {
    "id": "public_contacts",
    "phones": [
        {"label": "Гаряча лінія", "value": "+380 44 333 44 55"},
        {"label": "Відділ продажу", "value": "+380 50 123 45 67"},
    ],
    "emails": [
        {"label": "Загальний", "value": "info@eco.ua"},
        {"label": "Документи", "value": "docs@eco.ua"},
    ],
    "address": "м. Київ, вул. Лісова, 12, оф. 305",
