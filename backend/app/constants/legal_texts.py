...
<li>У разі підозри несанкціонованого доступу негайно повідомте нас на <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>.</li>
...
<h3>22. Контакти</h3>
<p>ТОВ «ЕКО-НОВА»<br/>
Email: <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a><br/>
Телефон: +380 44 333 44 55<br/>
...
<li>If you suspect unauthorised access, notify us immediately at <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>.</li>
...
<p>Володільцем персональних даних є ТОВ «ЕКО-НОВА». З питань обробки персональних даних звертайтеся: <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>, телефон +380 44 333 44 55.</p>
...
<p>Для реалізації прав напишіть на <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>. Ми відповімо у строк до 30 календарних днів.</p>
...
<p>The controller of personal data is ECO-NOVA LLC. For any privacy matters contact us at <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a> or +380 44 333 44 55.</p>
...
<p>To exercise your rights, write to <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>. We respond within 30 calendar days.</p>
...
<h3>11. Контакти</h3>
<p>Питання щодо використання cookies надсилайте на <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>. Додатково див. <a href="/privacy">Політику конфіденційності</a> та <a href="/terms">Умови використання</a>.</p>
...
<h3>11. Contact</h3>
<p>Questions about the use of cookies: <a href="mailto:info@eco-utyl.ua">info@eco-utyl.ua</a>. See also the <a href="/privacy">Privacy Policy</a> and the <a href="/terms">Terms of Use</a>.</p>
