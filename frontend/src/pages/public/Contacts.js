...
const T = {
  uk: {
    ...
    channels: [
      { label: "Телефон",  value: "+380 44 333 44 55", sub: "Диспетчерська цілодобово · Без вихідних", href: "tel:+380443334455", copy: "+380443334455" },
      { label: "Email",    value: "info@eco.ua",        sub: "Відповідь в робочий час — до 30 хвилин",  href: "mailto:info@eco.ua",  copy: "info@eco.ua" },
      { label: "Операції", value: "ops@eco.ua",         sub: "Склад, логістика та вивезення",            href: "mailto:ops@eco.ua",    copy: "ops@eco.ua" },
      { label: "Прес",     value: "press@eco.ua",       sub: "Для журналістів та аналітиків",            href: "mailto:press@eco.ua",  copy: "press@eco.ua" },
      { label: "Безпека",  value: "security@eco.ua",    sub: "Служба комплаєнсу та вразливостей",         href: "mailto:security@eco.ua", copy: "security@eco.ua" },
    ],
    locations: [
      { eye: "HQ",        name: "Київ · Центральний офіс",   addr: "вул. Екологічна, 1, Київ, 04050",     hours: "Пн–Пт · 9:00–18:00", phone: "+380 44 333 44 55" },
      { eye: "Warehouse", name: "Бровари · Логістичний хаб", addr: "вул. Промислова, 12, Бровари, 07401", hours: "Пн–Сб · 8:00–20:00", phone: "+380 44 333 44 57" },
      { eye: "Regional",  name: "Львів · Західна філія",     addr: "вул. Наукова, 7, Львів, 79060",       hours: "Пн–Пт · 9:00–18:00", phone: "+380 32 555 11 22" },
    ],
    faq: [
  ...
  en: {
    ...
    channels: [
      { label: "Phone",      value: "+380 44 333 44 55", sub: "Dispatch 24/7 · No days off",          href: "tel:+380443334455", copy: "+380443334455" },
      { label: "Email",      value: "info@eco.ua",        sub: "Reply within working hours — up to 30 min", href: "mailto:info@eco.ua",  copy: "info@eco.ua" },
      { label: "Operations", value: "ops@eco.ua",         sub: "Warehouse, logistics and collection",   href: "mailto:ops@eco.ua",    copy: "ops@eco.ua" },
      { label: "Press",      value: "press@eco.ua",       sub: "For journalists and analysts",          href: "mailto:press@eco.ua",  copy: "press@eco.ua" },
      { label: "Security",   value: "security@eco.ua",    sub: "Compliance and vulnerability desk",     href: "mailto:security@eco.ua", copy: "security@eco.ua" },
    ],
    locations: [
      { eye: "HQ",        name: "Kyiv · Head office",      addr: "1 Ekolohichna St., Kyiv, 04050",      hours: "Mon–Fri · 9:00–18:00", phone: "+380 44 333 44 55" },
      { eye: "Warehouse", name: "Brovary · Logistics hub", addr: "12 Promyslova St., Brovary, 07401",   hours: "Mon–Sat · 8:00–20:00", phone: "+380 44 333 44 57" },
      { eye: "Regional",  name: "Lviv · Western branch",   addr: "7 Naukova St., Lviv, 79060",          hours: "Mon–Fri · 9:00–18:00", phone: "+380 32 555 11 22" },
    ],
    faq: [
