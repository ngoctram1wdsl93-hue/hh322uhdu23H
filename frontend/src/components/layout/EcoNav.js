...
const PHONE_DISPLAY_FALLBACK = "+380 44 333 44 55";
const EMAIL_FALLBACK = "info@eco.ua";
...
/* Compact UA / EN language switcher (solid backgrounds — no transparency) */
function LangSwitch({ lang, setLang }) {
  ...
  return (
    <div className="econav__lang" role="group" aria-label="Language" data-testid="nav-lang-switch"
      style={{ display: "inline-flex", alignItems: "center", gap: 2, padding: 2, background: "#15301f", border: "1px solid rgba(255,255,255,0.14)", borderRadius: 999 }}>
      {codes.map((c) => {
        ...
        return (
          <button
            ...
            aria-pressed={active}
            style={{
              minWidth: 30, padding: "5px 9px", borderRadius: 999, border: 0, cursor: "pointer",
              fontSize: 12, fontWeight: 700, letterSpacing: ".04em", lineHeight: 1,
              background: active ? "#5BC47A" : "transparent",
              color: active ? "#14210b" : "#dcedc8",
    ...
    <>
      ...
      >
        ...
        <div className="econav__actions">
          <LangSwitch lang={lang} setLang={changeLang} />
