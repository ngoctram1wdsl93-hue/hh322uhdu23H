...
const UK_FALLBACK = {
  ...
  contacts: {
    title: "Контакти",
    phone: "+380 (44) 223-00-00", phoneHref: "tel:+380442230000",
    phone2: "", phone2Href: "",
    email: "info@eco.ua", email2: "",
    address: "м. Київ, вул. Екологічна, 1",
    hours: "Пн–Пт, 9:00–18:00",
    clientLoginLabel: "Вхід для клієнтів", clientLoginHref: "/client/login",
  },
  company: { legalName: "ТОВ «ЕКО-НОВА»", edrpou: "", registration: "" },
  newsletter: {
...
const EN_FALLBACK = {
  ...
  contacts: {
    ...
    phone2: "", phone2Href: "",
    email: "info@eco.ua", email2: "",
    address: "Kyiv, 1 Ekolohichna St.",
    hours: "Mon–Fri, 9:00–18:00",
    clientLoginLabel: "Client sign-in", clientLoginHref: "/client/login",
  },
  company: { legalName: "ECO.NOVA Utilization LLC", edrpou: "", registration: "" },
  newsletter: {
